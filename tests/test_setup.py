...
VENDORED = {
    ...
    'pydevd/_pydev_bundle/__init__.pyc',
    'pydevd/_pydev_bundle/_pydev_imports_tipper.py',
    'pydevd/_pydev_bundle/_pydev_calltip_util.pyc',
    ...
    'pydevd/_pydev_bundle/pydev_ipython_console.pyc',
    'pydevd/_pydev_bundle/pydev_ipython_console.py',
    'pydevd/_pydev_bundle/_pydev_completer.pyc',
    'pydevd/_pydev_bundle/_pydev_jy_imports_tipper.py',
    'pydevd/_pydev_bundle/pydev_override.pyc',
    'pydevd/_pydev_bundle/pydev_imports.py',
    'pydevd/_pydev_bundle/pydev_override.py',
    'pydevd/_pydev_bundle/_pydev_tipper_common.pyc',
    'pydevd/_pydev_bundle/_pydev_imports_tipper.pyc',
    'pydevd/_pydev_bundle/pydev_monkey.py',
    'pydevd/_pydev_bundle/pydev_localhost.py',
    'pydevd/_pydev_bundle/_pydev_filesystem_encoding.pyc',
    'pydevd/_pydev_bundle/pydev_ipython_console_011.pyc',
    'pydevd/_pydev_bundle/pydev_log.py',
    'pydevd/_pydev_bundle/pydev_ipython_console_011.py',
    'pydevd/_pydev_bundle/pydev_imports.pyc',
    'pydevd/_pydev_bundle/_pydev_tipper_common.py',
    'pydevd/_pydev_bundle/pydev_monkey_qt.py',
    'pydevd/_pydev_bundle/_pydev_log.py',
    'pydevd/_pydev_bundle/pydev_is_thread_alive.pyc',
    'pydevd/_pydev_bundle/pydev_monkey.pyc',
    'pydevd/_pydev_bundle/_pydev_filesystem_encoding.py',
    'pydevd/_pydev_bundle/pydev_console_utils.pyc',
    'pydevd/_pydev_bundle/fix_getpass.pyc',
    'pydevd/_pydev_bundle/pydev_versioncheck.py',
    'pydevd/_pydev_bundle/pydev_log.pyc',
    'pydevd/_pydev_bundle/pydev_umd.pyc',
    ...
    'pydevd/pydevd_plugins/__init__.pyc',
    'pydevd/pydevd_plugins/django_debug.pyc',
    'pydevd/pydevd_plugins/__init__.py',
    'pydevd/pydevd_plugins/jinja2_debug.pyc',
    'pydevd/pydevd_plugins/extensions/README.md',
    'pydevd/pydevd_plugins/extensions/__init__.pyc',
    'pydevd/pydevd_plugins/extensions/__init__.py',
    'pydevd/pydevd_plugins/extensions/types/pydevd_plugin_numpy_types.py',
    'pydevd/pydevd_plugins/extensions/types/__init__.pyc',
    'pydevd/pydevd_plugins/extensions/types/__init__.py',
    'pydevd/pydevd_plugins/extensions/types/pydevd_helpers.pyc',
    ...
    'pydevd/pydevd_plugins/extensions/types/pydevd_plugins_django_form_str.pyc',  # noqa
    'pydevd/pydevd_plugins/extensions/types/pydevd_plugin_numpy_types.pyc',
    ...
    'pydevd/_pydev_runfiles/__init__.pyc',
    'pydevd/pydevd_concurrency_analyser/pydevd_concurrency_logger.py',
    'pydevd/pydevd_concurrency_analyser/pydevd_concurrency_logger.pyc',
    'pydevd/pydevd_concurrency_analyser/pydevd_thread_wrappers.pyc',
    'pydevd/pydevd_concurrency_analyser/pydevd_thread_wrappers.py',
    'pydevd/pydevd_concurrency_analyser/__init__.pyc',
    ...
    'pydevd/_pydev_imps/_pydev_saved_modules.pyc',
    ...
    'pydevd/_pydev_imps/__init__.pyc',
    ...
    'pydevd/_pydevd_frame_eval/pydevd_frame_eval_main.pyc',
    ...
    'pydevd/_pydevd_frame_eval/__init__.pyc',
    ...
    'pydevd/pydev_ipython/__init__.pyc',
    ...
    'pydevd/_pydevd_bundle/pydevd_plugin_utils.pyc',
    'pydevd/_pydevd_bundle/pydevd_console.pyc',
    'pydevd/_pydevd_bundle/pydevd_vm_type.py',
    'pydevd/_pydevd_bundle/pydevd_resolver.pyc',
    'pydevd/_pydevd_bundle/pydevd_frame.pyc',
    'pydevd/_pydevd_bundle/pydevd_additional_thread_info_regular.py',
    'pydevd/_pydevd_bundle/pydevd_save_locals.pyc',
    'pydevd/_pydevd_bundle/pydevd_exec.pyc',
    'pydevd/_pydevd_bundle/pydevd_extension_utils.pyc',
    ...
    'pydevd/_pydevd_bundle/pydevd_dont_trace.pyc',
    'pydevd/_pydevd_bundle/pydevd_vars.pyc',
    'pydevd/_pydevd_bundle/pydevd_breakpoints.pyc',
    'pydevd/_pydevd_bundle/pydevd_frame.py',
    'pydevd/_pydevd_bundle/pydevd_comm.pyc',
    ...
    'pydevd/_pydevd_bundle/pydevd_io.pyc',
    'pydevd/_pydevd_bundle/pydevd_xml.pyc',
    'pydevd/_pydevd_bundle/pydevd_io.py',
    'pydevd/_pydevd_bundle/pydevd_dont_trace.py',
    'pydevd/_pydevd_bundle/pydevd_additional_thread_info_regular.pyc',
    'pydevd/_pydevd_bundle/pydevd_constants.pyc',
    'pydevd/_pydevd_bundle/pydevd_trace_dispatch.py',
    'pydevd/_pydevd_bundle/pydevd_signature.py',
    'pydevd/_pydevd_bundle/pydevd_trace_dispatch.pyc',
    ...
    'pydevd/_pydevd_bundle/pydevd_frame_utils.pyc',
    'pydevd/_pydevd_bundle/pydevd_stackless.pyc',
    'pydevd/_pydevd_bundle/pydevd_cython_wrapper.pyc',
    'pydevd/_pydevd_bundle/pydevd_exec2.py',
    'pydevd/_pydevd_bundle/pydevd_additional_thread_info.pyc',
    ...
    'pydevd/_pydevd_bundle/pydevd_dont_trace_files.pyc',
    'pydevd/_pydevd_bundle/pydevd_trace_dispatch_regular.pyc',
    'pydevd/_pydevd_bundle/pydevd_process_net_command.py',
    'pydevd/_pydevd_bundle/pydevd_command_line_handling.pyc',
    'pydevd/_pydevd_bundle/__init__.pyc',
    'pydevd/_pydevd_bundle/pydevd_resolver.py',
    'pydevd/_pydevd_bundle/pydevd_utils.py',
    'pydevd/_pydevd_bundle/pydevd_console.py',
    'pydevd/_pydevd_bundle/pydevd_trace_api.pyc',
    'pydevd/_pydevd_bundle/pydevd_referrers.py',
    'pydevd/_pydevd_bundle/pydevd_signature.pyc',
    'pydevd/_pydevd_bundle/pydevd_cython.c',
    'pydevd/_pydevd_bundle/pydevd_utils.pyc',
    'pydevd/_pydevd_bundle/pydevd_breakpoints.py',
    'pydevd/_pydevd_bundle/__init__.py',
    'pydevd/_pydevd_bundle/pydevd_trace_api.py',
    'pydevd/_pydevd_bundle/pydevd_vm_type.pyc',
    'pydevd/_pydevd_bundle/pydevd_custom_frames.pyc',
    'pydevd/_pydevd_bundle/pydevd_extension_api.pyc',
    'pydevd/_pydevd_bundle/pydevd_import_class.pyc',
    'pydevd/_pydevd_bundle/pydevd_save_locals.py',
    'pydevd/_pydevd_bundle/pydevd_kill_all_pydevd_threads.pyc',
