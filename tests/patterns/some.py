...
bytes.starting_with = lambda prefix: bytes.matching(re.escape(prefix) + b".*")
bytes.ending_with = lambda suffix: bytes.matching(b".*" + re.escape(suffix))
bytes.containing = lambda sub: bytes.matching(b".*" + re.escape(sub) + b".*")
...
str.starting_with = lambda prefix: str.matching(re.escape(prefix) + ".*")
str.ending_with = lambda suffix: str.matching(".*" + re.escape(suffix))
str.containing = lambda sub: str.matching(".*" + re.escape(sub) + ".*")
